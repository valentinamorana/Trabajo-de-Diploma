...
--
-- Las patentes mnuInspeccionDevolucion/Editar controlan SOLO la visibilidad
-- del menú de esta pantalla nueva: la escritura real (CambiarEstado,
-- RegistrarCargo) sigue exigiendo StockEditar/Stock, sin cambios — mismo
-- mecanismo de siempre, ahora con una pantalla propia en vez de reusar la
-- de Stock genérica.
--
...
-- ── 2) Patentes de menú mnuInspeccionDevolucion / Editar ─────────────────
...
FROM (VALUES
    ...
    ('Configurar Inspección de Devolución', 'mnuInspeccionDevolucionEditar', 'Inventario')
...
PRINT 'Permisos mnuInspeccionDevolucion/Editar asignados a Administrador y OperadorDeInventario.';
GO
