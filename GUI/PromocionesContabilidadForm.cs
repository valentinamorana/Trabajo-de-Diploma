...
namespace GUI
{
    ...
    public partial class PromocionesContabilidadForm : FormBase, IIdiomaObserver
    {
        ...
        private void BtnAprobar_Click(object sender, EventArgs e)
        {
            ...
            {
                MostrarError(Tr("err.promo.observacion_requerida_aprobar", "Ingresá una observación antes de aprobar."));
                return;
            }
            ...
            try
            {
                ...
                MostrarOk(Tr("msg.promo.aprobada", "Promoción '{0}' aprobada y activada.", new object[] { promocion.Nombre }));
        ...
        private void BtnRechazar_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtObservacion.Text))
            {
                MostrarError(Tr("err.promo.observacion_requerida_rechazar", "Ingresá una observación antes de rechazar."));
                return;
            }
            ...
            try
            {
                ...
                MostrarOk(Tr("msg.promo.rechazada", "Promoción '{0}' rechazada.", new object[] { promocion.Nombre }));
                txtObservacion.Clear();
                CargarPromociones();
            }
            catch (Exception ex) { MostrarError(ex); }
