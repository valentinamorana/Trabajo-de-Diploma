...
namespace GUI
{
    public partial class DashboardDeposito : FormBase, IIdiomaObserver
    {
        ...
        {
            this.Text          = Tr("dash.deposito.titulo",   "Panel de Depósito");
        ...
        private void CargarEnBackground()
        {
            Task.Run(() =>
            {
                ...
                {
                    System.Diagnostics.Trace.TraceWarning($"[DashboardDeposito] No se pudo cargar el dashboard: {ex.Message}");
                }
            });
        }
        ...
        private void ActualizarSesion()
        {
            ...
            {
                System.Diagnostics.Trace.TraceWarning($"[DashboardDeposito] No se pudo cargar la sesión: {ex.Message}");
            }
        }
