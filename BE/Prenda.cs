...
namespace BE
{
    ...
    public class Prenda
    {
        ...
        /// que el usuario confirme (ver GUI.Prendas). Transiciones válidas (solo desde
        /// el módulo de Prendas):
        ...
        /// </summary>
        public bool ControlarEstado(EstadoPrenda destino)
        {
            Estados.Estado estado;
            switch (Estado)
            {
                case EstadoPrenda.Disponible: estado = new Estados.EstadoDisponible(); break;
                case EstadoPrenda.EnLimpieza: estado = new Estados.EstadoEnLimpieza(); break;
                case EstadoPrenda.EnUso:      estado = new Estados.EstadoEnUso();      break;
                case EstadoPrenda.Baja:       estado = new Estados.EstadoBaja();       break;
                default: return false;
            }
            return estado.ControlarEstado(this, destino);
        }
    }
}
